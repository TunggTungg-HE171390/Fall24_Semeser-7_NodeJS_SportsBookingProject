      ...
      <View style={styles.carouselWrapper}>
        <Swiper
          ...
          <View style={styles.slide}>
            <Icon name="futbol-o" size={100} color="#000" /> {/* Bóng đá */}
          </View>
          <View style={styles.slide}>
            <MaterialCommunityIcons name="basketball" size={100} color="#000" />{' '}
            {/* Bóng rổ */}
          </View>
          <View style={styles.slide}>
            <MaterialCommunityIcons name="badminton" size={100} color="#000" />{' '}
            {/* Cầu lông */}
          </View>
          <View style={styles.slide}>
            <MaterialCommunityIcons name="billiards" size={100} color="#000" />{' '}
            {/* Bi-a */}
          </View>
          <View style={styles.slide}>
            <MaterialCommunityIcons name="tennis" size={100} color="#000" />{' '}
            {/* Tennis */}
          </View>
        </Swiper>
      </View>
