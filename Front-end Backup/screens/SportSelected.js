...
const sportsData = [
  { sportName: "Football", icon: <Icon name="futbol-o" size={100} color="#000" /> },
  { sportName: "Basketball", icon: <MaterialCommunityIcons name="basketball" size={100} color="#000" /> },
  { sportName: "Badminton", icon: <MaterialCommunityIcons name="badminton" size={100} color="#000" /> },
  { sportName: "Billiards", icon: <MaterialCommunityIcons name="billiards" size={100} color="#000" /> },
  { sportName: "Tennis", icon: <MaterialCommunityIcons name="tennis" size={100} color="#000" /> },
];
  ...
  return (
    <View style={styles.container}>
      <View style={styles.carouselWrapper}>
        <TouchableOpacity onPress={handlePrevious} style={[styles.arrowButton, styles.arrowLeft]}>
        ...
        <TouchableOpacity onPress={handleNext} style={[styles.arrowButton, styles.arrowRight]}>
